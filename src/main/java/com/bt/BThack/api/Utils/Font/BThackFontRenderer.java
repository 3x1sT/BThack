...
public final class BThackFontRenderer implements Mc {
    ...
    public BThackFontRenderer(String fontName, float fontSize) {
        name = fontName;
        size = fontSize;
    ...
    public static Font getFontByName(String name) throws IOException, FontFormatException {
        if (name == "Ubuntu") {
            return getFontFromInput("/assets/bthack/fonts/Ubuntu.ttf");
        } else if (name == "Lato") {
            return getFontFromInput("/assets/bthack/fonts/Lato.ttf");
        } else if (name == "Verdana") {
            return getFontFromInput("/assets/bthack/fonts/Verdana.ttf");
        } else if (name == "Comfortaa") {
            return getFontFromInput("/assets/bthack/fonts/Comfortaa.ttf");
        } else if (name == "Subtitle") {
            return getFontFromInput("/assets/bthack/fonts/Subtitle.ttf");
        } else if (name == "ComicSans") {
            return getFontFromInput("/assets/bthack/fonts/ComicSans.ttf");
        } else {
            return Font.createFont(Font.TRUETYPE_FONT, new File("/assets/bthack/fonts/" + name + ".ttf"));
        }
    }
    ...
    public static Font getFontFromInput(String path) throws IOException, FontFormatException {
        font = Font.createFont(Font.TRUETYPE_FONT, BThackFontRenderer.class.getResourceAsStream(path));
