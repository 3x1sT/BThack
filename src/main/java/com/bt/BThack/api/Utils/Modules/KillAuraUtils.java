...
public class KillAuraUtils implements Mc {
    public static void CoolDownAttack(Entity target, Thread thread, int postCooldownDelay) {
    ...
    public static Entity filterEntity(double range) {
        return mc.world.loadedEntityList.stream().filter(entity1 -> entity1 != mc.player && !entity1.isDead).min(Comparator.comparing(entity1 ->
    ...
    public static boolean isCurrentMob(Entity entity) {
        return entity instanceof EntityMob || entity instanceof EntityFlying || entity instanceof EntityAgeable || entity instanceof EntityAmbientCreature || entity instanceof EntityWaterMob || entity instanceof EntityGolem;
    }
    ...
    public static boolean isFriend(EntityPlayer player, String mode) {
    ...
    public static boolean isTeammate(EntityPlayer player, String mode) {
