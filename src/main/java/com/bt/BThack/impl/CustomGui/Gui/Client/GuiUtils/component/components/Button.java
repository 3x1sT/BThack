...
import com.bt.BThack.impl.CustomGui.Gui.Client.GuiUtils.component.components.sub.*;
...
public class Button extends Component {
	...
	public void renderRect(BufferBuilder builder, Tessellator tessellator) {
		RenderUtils.drawNoGL11Rect(parent.getX(), this.parent.getY() + this.offset, parent.getX() + parent.getWidth(), this.parent.getY() + 12 + this.offset, this.isHovered ? ColourUtils.integrateAlpha(new Color(Client.colourTheme.getBackgroundFontHoveredColour()).hashCode(), effect.getColor().getAlpha()) : ColourUtils.integrateAlpha(new Color(Client.colourTheme.getBackgroundFontColour()).hashCode(), effect.getColor().getAlpha()), builder, tessellator);
	}
