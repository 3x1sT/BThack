...
public class BThackMenu extends BThackGui {
    ...
    SmoothEmergenceEffect menuEffect = new SmoothEmergenceEffect(new Color(0,0,0,255), 125, 55);
    SmoothEmergenceEffect logoEffect = new SmoothEmergenceEffect(new Color(0,0,0,255), 145, 80);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
        ...
        Gui.drawRect(0,0, this.width, this.height, new Color(0,0,0, 255 - menuEffect.getColor().getAlpha()).hashCode());

        glColor4f(1, 1, 1, logoEffect.getColor().getAlpha() / 255f);
