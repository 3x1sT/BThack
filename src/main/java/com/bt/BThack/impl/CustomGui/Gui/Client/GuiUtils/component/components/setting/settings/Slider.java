...
public class Slider extends AbstractSetting implements Mc {
	...
	public Slider(Setting value, Button button, int offset, Module module) {
		super(offset, button, module, value);
	...
	public void renderRect(BufferBuilder builder, Tessellator tessellator) {
		...
		RenderUtils.drawNoGL11Rect(parent.parent.getX(), parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 15, ColourUtils.integrateAlpha(new Color(Client.colourTheme.getBackgroundFontColour()).hashCode(), (int) (parent.effect.getColor().getAlpha() / 1.17)), builder, tessellator);
