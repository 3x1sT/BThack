...
public class ExtraTab extends Module {
    ...
    public static String getPlayerName(NetworkPlayerInfo info) {
        ...
        if (clan != null) {
            return name + ChatFormatting.RESET + "[" + ChatFormatting.BOLD + Objects.requireNonNull(clan.getName()) + ChatFormatting.RESET + "]";
        }

        return FriendsUtils.isFriend(name) ? ChatFormatting.GREEN + name : EnemiesUtils.isEnemy(name) ? ChatFormatting.RED + name : name;
    }
