package com.bt.BThack.impl.Module.OTHER.TopperRadar;
...
public class TopperRadar extends Module {
    ...
    public void onClientTick(TickEvent.ClientTickEvent e) {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            if (!getCheckbox(this.name, "Allies")) {
                if (AlliesUtils.isAlly(player)) continue;
            }
            ...
            if (armorMatches >= getSlider(this.name, "Min amount of armor")) {
                ...
                if (getCheckbox(this.name, "AutoDisconnect")) {
                    new TopperRadarDisconnectThread().start();
                    pause = true;
                }
            }
        }
