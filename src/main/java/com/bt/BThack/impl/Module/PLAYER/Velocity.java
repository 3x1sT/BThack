...
public class Velocity extends Module {
    public Velocity() {
        ...
        addSlider("Velocity Vertical", this, 0.0,0.0,100.0,true);
        addSlider("Velocity Horizontal", this, 0.0,0.0,100.0,true);

        addCheckbox("Explosions", this, true);
        addSlider("Expl Vertical", this, 0.0,0.0,100.0,true);
        addSlider("Expl Horizontal", this, 0.0,0.0,100.0,true);
