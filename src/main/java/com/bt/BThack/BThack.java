...
public class BThack implements Mc {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (TinySound.isInitialized()) {
            ...
            initErr("The sound engine is not initialized! Minecraft crashes automatically.");
        }
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        try {
            ...
            if (RusherHackCheck.isRusherHack) {
                Client.getModuleByName("Font").setToggled(false);
                Client.getModuleByName("BThackMainMenu").setToggled(false);
            }
